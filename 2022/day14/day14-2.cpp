...
const int xs=329; //63;
const int ys=164; //163
const int x_off = 336; //443
...
int main() {
  ...
  draw_line( 500 - maxy -3, maxy+2, 500 + maxy +3, maxy+2 );
  ...
  for ( auto i=0; i<26968 && cont; i++)
  {
    ...
    {
      if ( sand_it->first == 500-x_off
        && sand_it->second == 0
        && grid[sand_it->first+1][sand_it->second+1]=='o')
      {  
        cont = false; 
        cnt++;
        break;
