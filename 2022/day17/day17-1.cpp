...
void init_stack( short stack[8088] )
{
  for ( auto i=0; i<8088; ++i )
  {
    stack[i] = 0x101;
  }
  stack[0] = 0x1ff;
...
void print_stack( short stack[8088], int floor, int ceiling, BlockS blk, int blk_pos )
{
...
int main() {
  ...
  print_stack( stack, ceiling-12 , blk_pos+8, block, blk_pos );
